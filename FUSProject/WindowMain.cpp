...
WindowMain::WindowMain(HINSTANCE hInst, const wchar_t* name, HWND hParent, Controller* ctrl) : handle(0), instance(hInst), controller(ctrl), winStyle(WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN),
																			 ...
																			 parentHandle(hParent), menuHandle(0)
{
	...
	winClass.lpfnWndProc = WndProcMain;
	winClass.hInstance = instance;
	winClass.hbrBackground = (HBRUSH)GetStockObject(WHITE_BRUSH);
	winClass.lpszClassName = name;
	winClass.lpszMenuName = LPCTSTR(MAKEINTRESOURCE(IDR_MENU1));
...
///////////////////////////////////////////////////////////////////////////////
void WindowMain::show(int cmdShow)
{
